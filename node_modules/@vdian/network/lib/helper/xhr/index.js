...
import { serialize, appendParams } from '../serialize';
        ...
        if (util.isResponseOk(status_1)) {
            try {
                ...
                return invokeHook(options.beforeError, {
                    ...
                    response: response,
                    options: options,
                    error: createError(e.message, -1 /* XHR_ERROR */)
                }, error);
            }
            ...
            invokeHook(options.beforeError, {
                ...
                response: response,
                options: options,
                error: createError('Network Error', -1 /* XHR_ERROR */)
            }, error);
        }
    }
}
...
export default function xhr(options) {
    ...
    function send(_a) {
        ...
        request.send(options.method === GET_METHOD ? null : serialize(options.data));
    }
    function init(_a) {
        var request = _a.request, options = _a.options;
